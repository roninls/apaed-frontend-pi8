...
import { faArrowAltCircleRight, faBoxes, faEdit } from '@fortawesome/free-solid-svg-icons';
          ...
          Cell: ({ cell: { value: productStock } }) => (
            <div>
              ...
              {/* <Button
                className="mx-3"
                tag={Link}
                to={`/${user.role.name === AUTHORITIES.ADMIN ? 'admin' : 'bazar'}/ProductSold`}
                outline
                color="secondary"
                onClick={() => props.setToTransferFoodStampProduct(productStock, productStock.count)}
              ...
              <Button
                className="mx-3"
                tag={Link}
                to={`/${user.role.name === AUTHORITIES.ADMIN ? 'admin' : 'user'}/ProductSold`}
                outline
                color="secondary"
                onClick={() => props.setToTransferProduct(productStock, productStock.count)}
                title="Produto Vendido"
